...
paused trial can in principle be resumed in the future, and your disk may fill
up with `delete_checkpoints=True`` as well. In this case, you can activate
speculative early checkpoint removal, by passing
