...
def create_objects_for_tuner(
    ...
    callbacks = [StoreResultsCallback(final_results_composer=final_results)]
...
def start_benchmark_local_backend(
    ...
    :param final_results: If given, this is used to compose final results at the
        end of tuning, which are written as JSON file
