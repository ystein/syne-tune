...
methods = {
    ...
    Methods.ASHA_RCP_20: lambda method_arguments: ASHA(
        method_arguments,
        type="promotion",
        early_checkpoint_removal_kwargs=dict(
            max_num_checkpoints=10,
...
methods = {
    k: methods[k] for k in [Methods.ASHA_RCP_BASE_RANDOM, Methods.ASHA_RCP_BASE_BYLEVEL]
}
